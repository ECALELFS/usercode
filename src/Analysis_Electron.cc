...
bool Analysis_Electron::isIsolatedVBTF80() {
...
bool Analysis_Electron::isIsolatedVBTF95() {
...
bool Analysis_Electron::electronIDVBTF80() {
...
bool Analysis_Electron::separatedIDVBTF80() {
...
bool Analysis_Electron::electronIDVBTF95() {
...
bool Analysis_Electron::conversionRejectionVBTF80() {
...
bool Analysis_Electron::conversionRejectionVBTF95() {
...
bool Analysis_Electron::passedVBTF80() {
...
bool Analysis_Electron::passedTrigger80() {
...
bool Analysis_Electron::passedVBTF95() {
...
double Analysis_Electron::combinedIsoRel() {
...
bool Analysis_Electron::separatedIsoRel() {
