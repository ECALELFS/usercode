...
def printFillCfg( Gamma_MVA, outputfile, njob, outdir, OnlyContCorr, nInter, useES, cuts4s9):
    ...
    if not Gamma_MVA:
       ...
       outputfile.write("#NewGammaDumper_Gun\n")
       outputfile.write("process.load('Analysis.Modules.NewGammaDumper_Gun_cfi')\n")
       GunName = 'NewGammaDumper_Gun'
    outputfile.write("if isGun:\n")
    outputfile.write("   process." + GunName  + ".OutputFile = cms.untracked.string('/tmp/LocalPi0Gun_" + njob  + ".root')\n")
    outputfile.write("   process." + GunName  + ".outfilename_ContCorr = cms.untracked.string('/tmp/ContCorr_" + njob  + ".root')\n")
    outputfile.write("else:   \n")
