...
//*************************************************************************************************
void PlotRegressionPerformance(string applyingFilename, string outDirectoryName, Int_t Option) {  
  ...
  // outDirectoryName	= directory to which the generated histograms are saved in .gif
  ...
  cv->SaveAs((outDirectoryName + "EnergyResponse_example_binOption" + OptionStr + ".gif").c_str());
  cv->SaveAs((outDirectoryName + "EnergyResponse_example_binOption" + OptionStr + ".root").c_str());
} 
